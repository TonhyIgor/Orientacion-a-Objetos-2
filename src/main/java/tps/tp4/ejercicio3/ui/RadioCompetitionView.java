...
public class RadioCompetitionView extends JFrame {
    ...
    private ManejoConcurso manejador;

    public RadioCompetitionView(ManejoConcurso manejador) {
    ...
    private void formElements() {
        ...
        btnOk.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                try {
                    ...
                    JOptionPane.showMessageDialog(contentPane, excep.getMessage());
                    btnOk.setEnabled(true);
                }
            }
        });
        ...
        DefaultComboBoxModel<Concurso> boxModel = new DefaultComboBoxModel<>();
        comboBox = new JComboBox<>(boxModel);
        List<Concurso> listaConcursos = todosLosConcursos();
        listaConcursos.forEach(boxModel::addElement);
    }

    private void saveInscription() {
        this.manejador.agregarParticipante(txtName.getText(), txtLastName.getText(), txtId.getText(),
                txtPhone.getText(), txtEmail.getText(), ((Concurso) comboBox.getSelectedItem()).id());
    }

    private List<Concurso> todosLosConcursos() {
        return this.manejador.concursosActivos();
    }
